        ...
        <div className="container">
          ...
          <div className="module-grid">
            {MODULES.map((m, mi) => {
              ...
              const roman = ["i", "ii", "iii", "iv", "v", "vi", "vii", "viii", "ix", "x", "xi", "xii", "xiii", "xiv", "xv", "xvi", "xvii", "xviii"][mi];
              return (
...
const ModulePage = ({ moduleId, progress, toggleProgress, nav, user, onLogin }) => {
  ...
  const roman = ["I", "II", "III", "IV", "V", "VI", "VII", "VIII", "IX", "X", "XI", "XII", "XIII", "XIV", "XV", "XVI", "XVII", "XVIII"][idx];
